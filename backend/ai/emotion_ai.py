...
_EMOTION_LEXICON = {
    "fear": {
        "en": [
            ...
            "unsafe", "panic", "shaking", "trembling", "kill us", "kill me", "murder",
            "attacked", "assaulted", "stalking", "dread", "alarmed", "horrified"
        ],
        "te": [
    ...
    "distress": {
        ...
        "te": [
            ...
            "తట్టుకోలేకపోతున్నాను", "రక్తం", "అత్యవసరం", "ఆపద"
        ],
        "hi": [
        ...
        "ta": [
            "உதவி", "காப்பாற்றுங்கள்", "அழுகை", "வலி", "துன்பம்", "அவசரம்", "வதை"
        ],
        "mr": [
            "मदत", "वाचवा", "रडणे", "वेदना", "त्रास", "अत्याचार", "तातडीने"
        ],
        "kn": [
            "ಸಹಾಯ", "ಕಾಪಾಡಿ", "ಅಳು", "ನೋವು", "ಹಿಂಸೆ", "ತುರ್ತು", "ಸಂಕಷ್ಟ"
        ]
    },
    "sadness": {
        "en": [
...
def detect_emotion(text: str, detected_language: str = "en", speech_features: Optional[Dict] = None) -> Dict:
    ...
    greetings = ["hello", "hi", "hey", "hello hello", "good morning", "namaste", "నమస్కారం", "నమస్తే", "नमस्ते", "வணக்கம்", "नमस्कार", "ನಮಸ್ಕಾರ"]
