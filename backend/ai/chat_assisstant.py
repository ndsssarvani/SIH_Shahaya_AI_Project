...
5. If the user describes immediate violence or danger, prioritize safety and
   direct them to 112 and 14566.
...
INTENT_RESPONSES: Dict[str, Dict[str, str]] = {
    ...
    "threat_violence": {
        "en": (
            "Your immediate safety is the first priority. If there is an immediate physical threat, "
            "move to a safer place if you can and call 112 or 14566; under Section 15A of the SC/ST (PoA) Act, "
            "victims and witnesses have statutory protection rights. Are you in a physically safe place right now?"
        ),
        "te": (
            "మీ తక్షణ భద్రతే మొదటి ప్రాధాన్యత. వెంటనే ప్రాణాపాయం ఉంటే వీలైనంత త్వరగా సురక్షితమైన ప్రదేశానికి వెళ్లి "
            "112 లేదా 14566కు కాల్ చేయండి; SC/ST (PoA) చట్టంలోని సెక్షన్ 15A కింద బాధితులు మరియు సాక్షులకు రక్షణకు సంబంధించిన హక్కులు ఉన్నాయి. "
            "ప్రస్తుతం మీరు సురక్షితమైన ప్రదేశంలో ఉన్నారా?"
        ),
        "hi": (
            "आपकी तत्काल सुरक्षा सबसे महत्वपूर्ण है। यदि अभी शारीरिक खतरा है तो संभव हो तो सुरक्षित स्थान पर जाएँ और "
            "112 या 14566 पर कॉल करें; SC/ST (PoA) अधिनियम की धारा 15A के तहत पीड़ितों और गवाहों के लिए सुरक्षा संबंधी अधिकार हैं। "
            "क्या आप अभी सुरक्षित स्थान पर हैं?"
        ),
        "ta": (
            "உங்கள் உடனடி பாதுகாப்பே முதன்மையானது. உடனடி உடல் ஆபத்து இருந்தால் முடிந்தால் பாதுகாப்பான இடத்திற்குச் சென்று "
            "112 அல்லது 14566க்கு அழைக்கவும்; SC/ST சட்டத்தின் பிரிவு 15A கீழ் பாதிக்கப்பட்டவர்கள் மற்றும் சாட்சிகளுக்கு பாதுகாப்பு உரிமைகள் உள்ளன. "
            "நீங்கள் இப்போது பாதுகாப்பான இடத்தில் இருக்கிறீர்களா?"
        ),
        "mr": (
            "तुमची तात्काळ सुरक्षा ही सर्वात महत्त्वाची आहे. त्वरित शारीरिक धोका असल्यास शक्य असल्यास सुरक्षित ठिकाणी जा "
            "आणि 112 किंवा 14566 वर संपर्क करा; SC/ST (PoA) कायद्याच्या कलम 15A अंतर्गत पीडित व साक्षीदारांना संरक्षणाशी संबंधित हक्क आहेत. "
            "तुम्ही सध्या सुरक्षित ठिकाणी आहात का?"
        ),
        "kn": (
            "ನಿಮ್ಮ ತಕ್ಷಣದ ಸುರಕ್ಷತೆಯೇ ಮೊದಲ ಆದ್ಯತೆ. ತಕ್ಷಣದ ದೈಹಿಕ ಅಪಾಯವಿದ್ದರೆ ಸಾಧ್ಯವಾದರೆ ಸುರಕ್ಷಿತ ಸ್ಥಳಕ್ಕೆ ತೆರಳಿ "
            "112 ಅಥವಾ 14566ಕ್ಕೆ ಕರೆ ಮಾಡಿ; SC/ST ಕಾಯ್ದೆಯ ಕಲಂ 15A ಅಡಿಯಲ್ಲಿ ಪೀಡಿತರು ಮತ್ತು ಸಾಕ್ಷಿಗಳಿಗೆ ರಕ್ಷಣೆಯ ಹಕ್ಕುಗಳಿವೆ. "
...
CRISIS_KWS = [
    ...
    "చనిపోవాలని", "ఆత్మహత్య", "చావాలని",
    "आत्महत्या", "मरना चाहता", "मरना चाहती",
    "தற்கொலை", "சாக வேண்டும்",
    "आत्महत्या करायची", "ಸಾಯಲು ಬಯಸುತ್ತೇನೆ",
]
...
THREAT_KWS = [
    ...
    "బెదిరిస్తున్నారు", "చంపుతామని", "దాడి", "కొట్టారు", "భయం",
    "धमकी", "मारा", "पीटा", "மிரட்டல்", "தாக்கினார்கள்",
    "धमकावले", "ಹಲ್ಲೆ",
]
...
CASTE_KWS = [
    ...
    "land grab", "displaced", "bahishkar", "chhuachhut", "jati",
    "బహిష్కరణ", "కుల", "అంటరానితనం", "దళిత",
    "बहिष्कार", "जाति", "छुआछूत", "புறக்கணிப்பு",
    "ஜாதி", "ಜಾತಿ", "ಬಹಿಷ್ಕಾರ",
]
...
COMPENSATION_KWS = [
    ...
    "పరిహారం", "డబ్బులు", "మువాబ్జా", "पैसे", "मुआवजा",
...
COUNSELLOR_KWS = [
    ...
    "anxiety", "can't sleep",
    "కౌన్సెలర్", "కౌన్సెలింగ్", "బాధగా", "నిద్ర",
    "परामर्श", "काउंसलर", "ஆலோசகர்", "समुपदेशक", "ಸಮಾಲೋಚಕ",
]

GREETING_KWS = [
    "hello", "hi", "hey", "hello hello", "good morning", "good evening",
...
SAFE_KWS = [
    ...
    "క్షేమంగా", "సురక్షితంగా", "सुरक्षित", "ठीक हूँ",
...
def _generate_with_gemini(
    ...
    try:
        ...
        prompt = (
            ...
            "Respond directly to the user's message. Do not claim that an "
