...
SAFETY_NET_KEYWORDS = {
    ...
    "intimidation": [
        "knife", "gun", "weapon", "following me", "follow me", "stalking", "chasing",
        "kill me", "kill us", "threatened", "threatening", "make sure i regret",
    ],
    "fear": [
        "terrified", "petrified", "unsafe", "in danger", "seen a knife", "knife with him",
    ],
