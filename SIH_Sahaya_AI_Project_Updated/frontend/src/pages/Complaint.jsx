...
function botReplyFor(actionKeyOrText, level, isCrisis, lang = "English") {
  ...
  const crisisKws = [
    ...
    "చనిపోవాలని", "ఆత్మహత్య", "आत्महत्या", "मरना", "தற்கொலை", "ಸಾಯಲು"
  ];
  if (isCrisis || crisisKws.some((kw) => raw.includes(kw))) {
    return langDict.crisis_reply;
  }

  const threatKws = [
    "knife", "gun", "weapon", "blade", "sword", "following", "stalking", "chasing",
    "kill", "attack", "threat", "danger", "unsafe", "hurt", "harm", "dhamki",
    "కత్తి", "తుపాకీ", "ఆయుధం", "వెంబడిస్తున్నారు", "వెంటపడుతున్నారు", "చంపేస్తాం",
    "चाकू", "हथियार", "बंदूक", "पीछा", "हमला", "खतरा", "कथी", "துப்பாக்கி"
  ];
  if (threatKws.some((kw) => raw.includes(kw))) {
